...
func (h *Handler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case strings.HasPrefix(r.URL.Path, "/api/orchestration")://click2cloud-orchestration
		http.StripPrefix("/api", h.OrchestrationHandler).ServeHTTP(w, r)//click2cloud-orchestration
